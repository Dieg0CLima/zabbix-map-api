...
ActiveRecord::Schema[8.0].define(version: 2026_05_20_180000) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "authentication_source", default: "local", null: false
    t.index ["admin"], name: "index_users_on_admin"
    t.index ["authentication_source"], name: "index_users_on_authentication_source"
